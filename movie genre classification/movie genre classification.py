...
# Get unique genres from train data and update genre_list
unique_genres = get_unique_genres(train_data, 'GENRE')
genre_list = sorted(list(unique_genres))  # Ensure the list is sorted for consistent ordering
...
# Load test data (ensure you have a test data file)
try:
...
# Append evaluation metrics to the file
